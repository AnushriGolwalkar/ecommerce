...
<head>
  ...
  <link href={{url("Admin/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700")}} rel="stylesheet">
</head>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
                <a href="Category/display" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Category </p>
                </a>
            </li>
            <li class="nav-item">
              <a href="Product/addproduct" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>Add Product </p>
              </a>
          </li>
          <li class="nav-item">
              <a href="Product/display" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>Manage Product </p>
              </a>
          </li>
          <li class="nav-item">
            <a href="Coupon/addcoupon" class="nav-link active">
              <i class="far fa-circle nav-icon"></i>
              <p>Add coupon </p>
            </a>
        </li>
        <li class="nav-item">
            <a href="Coupon/display" class="nav-link active">
              <i class="far fa-circle nav-icon"></i>
              <p>Manage coupon </p>
            </a>
        </li>
        <li class="nav-item">
            <a href="Banner/addbanner" class="nav-link active">
              <i class="far fa-circle nav-icon"></i>
              <p>Add Banner </p>
            </a>
        </li>
        <li class="nav-item">
            <a href="Banner/display" class="nav-link active">
              <i class="far fa-circle nav-icon"></i>
              <p>Manage Banner </p>
            </a>
        </li>
