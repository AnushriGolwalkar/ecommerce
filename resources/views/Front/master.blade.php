...
<head>
    ...
    <title>Mysportyzone</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{url('Front/assets/img/favicon.ico')}}}" />
...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme2">
    <div class="inner">
        ...
        <a href="wishlist.html" class="btn theme--btn2 btn--lg d-block d-sm-inline-block rounded-5 mt-30">view
            wishlist</a>
    </div>
</div>
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme2">
    <div class="inner">
        ...
        <a href="cart.html" class="btn theme--btn2 btn--lg d-block d-sm-inline-block rounded-5 mr-sm-2">view
            cart</a>
                ...
                <div class="col-xl-3 col-lg-4">
                    <nav class="navbar-top pb-2 pb-md-0">
                        <ul class="d-flex justify-content-center justify-content-md-end align-items-center">
                            ...
                            <li><a href="{{url('myaccount')}}">{{Auth::user()->name}}</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-sm-5 col-lg-3 order-first">
                    <div class="logo text-center text-sm-left mb-30 mb-sm-0">
                        <a href="index.html"><img src="{{url('Front/assets/img/logo/logo.png')}}" alt="logo" style="max-width:70%"></a>
                    </div>
                </div>
                        ...
                        <div class="cart-block-links theme2">
                            <ul class="d-flex">
                                ...
                                <li class="mr-0 cart-block position-relative">
                                    <a class="offcanvas-toggle" href="{{url('cart')}}">
                                        <span class="position-relative">
                                            <i class="icon-bag"></i>
                                            <span class="badge cbdg1">3</span>
                                        </span>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        ...
                        <p class="text mb-30">One team, one mission, one goal, 100% determination.</p>
                        <div class="address-widget mb-30">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="title text-dark"><a href="tel:+1(123)8889999">9424600374</a></h4>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="text-left">
                        <p class="mb-3 mb-md-0">Copyright &copy; <a href="https://hasthemes.com/">Mysportyzone</a>. All
                            Rights Reserved</p>
                    </div>
                </div>
